...
import { createInputControlPanel, type InputControlPanelRefs } from './panels/input-control-panel';
...
export interface LayoutRefs {
  ...
  inputControl: InputControlPanelRefs;
}
...
export function createLayout(options: LayoutOptions): LayoutRefs {
  ...
  const inputControl = createInputControlPanel({
    lesson: options.initialLesson,
    onApply: options.onInputApply,
  });
